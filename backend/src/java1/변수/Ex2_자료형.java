...
public class Ex2_자료형 { // class s
	...
	public static void main(String[] args) { // main s
		...
		byte 바이트변수2 = 127;  System.out.println("바이트변수2 :" + 바이트변수2);
			//	byte 바이트변수3 = 128;  System.out.println("바이트변수3 :" + 바이트변수3); 오류발생 : 저장범위 초과
		...
		int 인트변수1 = 100000000; System.out.println("인트변수 : " + 인트변수1);
			// int 인트변수2 = 30000000000;  // 오류발생 : 저장범위 초과
		...
		int var3 = 365;
		System.out.println("10진수[365--int(10진수)-->134] :" + var3);
		int var4 = 0xb3;
...
/*
	진수
		* 진수를 다른 진수로 변환해서 다양한 표현 단위 사용할수 있다. --> 많은 단위를 표현가능
		2진수		0,1 [ 기계어, 이진 코드 ] 문제: 표현단위가적다----> 8진수,10진수,16진수
		8진수		0,1,2,3,4,5,6,7
