...
public class AdminView {
	...
	void inMenu() {
		...
		else {System.out.println("안내) 메뉴 등록 실패 했습니다.");}
	}
	// 3. 제품 추가 화면
	void inProduct() { 
	/////////// 현재 메뉴 목록 /////////////
	...
	/////////// 제품 추가 ////////////
	System.out.print("제품명 : "); 	String pname = scanner.nextLine();// nextLine 엔터를 누르면 종료
	System.out.print("가격 : "); 	int pprice = scanner.nextInt();
	System.out.print("소개 : "); 	String pcommnet = scanner.nextLine();
	System.out.print("초기 재고");	short pamount = scanner.nextShort();
	
	boolean result =
	acontrol.inProduct( pname, pprice, pcommnet, pamount, mno);
	
	if ( result ) {System.out.println("안내) 제품 등록했습니다. ");}
