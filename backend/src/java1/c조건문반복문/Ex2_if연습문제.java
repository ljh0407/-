...
public class Ex2_if연습문제 {
	...
	System.out.println("문제1)정수입력1: "); int 문제1_1 = scanner.nextInt();
	System.out.println("문제1)정수입력2: "); int 문제1_2 = scanner.nextInt();
	...
	System.out.println("문제2)정수입력1: "); int 문제2_1 = scanner.nextInt();
	System.out.println("문제2)정수입력2: "); int 문제2_2 = scanner.nextInt();
	System.out.println("문제2)정수입력3: "); int 문제2_3 = scanner.nextInt();
	int max = 문제2_1; // 첫번째 데이터를 가장 큰수로 지정
	if( max < 문제2_2) {max = 문제2_2;} // 두번째 데이터가 max보다 크면 max에 두번째 데이터를 넣기
	if( max < 문제2_3) {max = 문제2_3;} // 세번째 데이터가 max보다 크면 max에 세번째 데이터를 넣기
	System.out.println("결과2 : 가장큰수 : " + max);
	*/
	/*
	// 문제3 : 3개의 정수를 입력받아서 오름차순 / 내림차순 [ 경우의수 : 3 7 5 : 3>7 , 3>5 , 7>5 ]
	System.out.print("문제3)정수1 입력1: "); int 문제3_1 = scanner.nextInt();
	System.out.print("문제3)정수2 입력2: "); int 문제3_2 = scanner.nextInt();
	System.out.print("문제3)정수3 입력3: "); int 문제3_3 = scanner.nextInt();
	...
	System.out.printf(" %d %d %d \n" , 문제3_1 , 문제3_2 , 문제3_3); //출력방식1
	System.out.println( 문제3_1 +""+ 문제3_2 +""+ 문제3_3 ); //출력방식1
	
	
	// 문제4 : 점수를 입력받아 점수가 90점 이상이면 합격 아니면 불합격 출력 [ 경우의수 : 2개 ]
	System.out.println("문제4) 점수 입력: "); int 문제4 = scanner.nextInt();
	...
	// 문제5 
		...
		//			  점수가 70점 이상이면 C등급
		//              그외 재시험
	System.out.println("문제5)점수 입력 : "); int 문제5 = scanner.nextInt();
 ...
 */
	/*
	System.out.println("문제6)국어 점수 입력 : "); int 국어 = scanner.nextInt();
	System.out.println("문제6)영어 점수 입력 : "); int 영어 = scanner.nextInt();
	System.out.println("문제6)수학 점수 입력 : "); int 수학 = scanner.nextInt();
...
//문제7 로그인페이지
	...
	//if( 아이디 == "admin") { // 아이디가 admin 이면 [ string == (x) ]
		...
		// 클래스( 객체 = 기본자료형 외 ) 는 비교연산자 불가능  --> 비교 메소드(함수)
		// 기본자료형 ==  vs객체명.equals( 객체명 )
		// . : 접근연산자 ( 내부 )
		if(아이디.equals("admin")  ) {
			if(비밀번호.equals("1234") ) {
