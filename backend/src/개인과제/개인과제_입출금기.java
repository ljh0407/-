...
public class 개인과제_입출금기 {
	...
	public static void main(String[] args) {
		...
		if( 버튼 == 1 ) {
			...
			System.out.println("1.거래 더하기 2.거래종료"); int 버튼2 = scanner.nextInt();
			if( 버튼2 == 1 ) {// 거래 더 하기  초기화면으로 이동
				
			}
			else if ( 버튼2 == 2 ) { // 거래종료 인삿말
				System.out.println("거래 감사합니다. 카드를 받아주세요.");
			}break;
			...
			if( 비밀번호 != 입력번호 ) {System.err.println("비밀번호가 틀렸습니다."); break;}
...
//		else if ( 버튼 == 3 ) {System.out.println("잔액 조회를 하시겠습니까?"); int  = scanner.nextInt();
	//	}
		else if ( 버튼 == 3 ) {System.out.println("감사합니다. 카드를 받아주세요.");break;}
		else {}
